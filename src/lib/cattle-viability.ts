...
export const defaultCattleViabilityInput: CattleViabilityInput = {
  propertyName: "nome da fazenda",
  lotSize: 320,
  initialLiveWeightKg: 232,
  finalLiveWeightKg: 450,
  carcassYieldPercent: 50,
  averageDailyGainKg: 0.484,
  initialDate: "2025-11-15",
  productionCostMode: "detailed",
  dailyProductionCostPerHead: 2.510612,
  intakeValue: 0.04,
  intakeUnit: "percentLiveWeight",
  supplementName: "PROVEMIX NUTREPASTO",
  supplementCostPerKg: 4.33,
  initialArrobaPrice: 366,
  saleArrobaPrice: 300,
  operationalCostPerHeadDay: 0.26,
  pastureCostPerHeadDay: 1.66,
  insuranceCostPerArroba: 0,
  financedAnimalsValue: 864000,
