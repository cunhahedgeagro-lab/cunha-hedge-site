        ...
        <header className="border-b border-primary/20 bg-white shadow-lg">
          <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
            ...
            <nav className="gap-8 hidden md:flex">
              <a href="/quem-somos" className="text-gray-600 hover:text-primary transition-colors font-medium">Quem somos</a>
              <a href="/servicos" className="text-gray-600 hover:text-primary transition-colors font-medium">Serviços</a>
              <a href="/contato" className="font-semibold text-primary hover:text-primary/80 bg-primary/10 px-4 py-2 rounded-lg">Contato</a>
            </nav>
